    ...
    <div style={s.page}>
      <div style={s.card}>
        <div style={s.header}>
          ...
          <h2 style={s.title}>Join Sonara</h2>
          <p style={s.sub}>Your next instrument is waiting</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={s.form}>
          <div style={s.field}>
            ...
            <input style={s.input} name="username" value={form.username} onChange={handleChange} required minLength={3} placeholder="johndoe" />
          </div>
          <div style={s.field}>
          ...
          <div style={s.row}>
            <div style={s.field}>
              ...
              <input style={s.input} type="password" name="password" value={form.password} onChange={handleChange} required placeholder="Min. 6 chars" />
            </div>
            <div style={s.field}>
              <label style={s.label}>Confirm</label>
              <input style={s.input} type="password" name="confirm" value={form.confirm} onChange={handleChange} required placeholder="Repeat" />
            </div>
          </div>
...
const s = {
  ...
  card: {
    ...
    width: '100%', maxWidth: 440, border: '1px solid #2a2016',
